...
class Sam {
 ...
 public:
  ...
  std::vector<std::vector<cv::Point>> autoSegmentContour(const cv::Size& numPoints, cbProgress cb = {}, const double iouThreshold = 0.86,
      const double minArea = 1000, int* numObjects = nullptr) const;
};
